...
train_style = 'all'  # options: all/multi !!!
# train_spec = 'single'  # training specification !!!
E_Fermi_Hartree = -0.18335929913110  # change when use!!!, grep Chemical openmx.out
lowest_band = -1.02
max_inter = 300
num_band = 70
...
# write inference.ini in band prediction working directory, change radius when use!!!
...
bash_cmd = ''
for i in range(45):  # index of k points, change when use!!!

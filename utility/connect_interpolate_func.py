# from Gongxx
# algo supported from Liyang
import numpy as np
import json
from scipy import interpolate

def connect_band(inputpath, outputpath, tol=1, spline_interpolate=False, fine_grid_size=90):
    ...
    with open(outputpath+'/band_reconnect.json', 'w') as f:
        json.dump(data, f)

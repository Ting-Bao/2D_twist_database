...
processed_structure = 'CONTENT2' # containing hamiltonians.h5, element.dat, orbital_types.dat, info.json
...
for k, v in dif.items():
    ...
    filename =save_path+ '-'.join(str(k).split())

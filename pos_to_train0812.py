...
n_element, atomic_number, N_orbital, orbitals_array = pos_to_train_input('POSCAR', 1)
orbital_set, atomic_number_set = gen_orbital_set(n_element, atomic_number, N_orbital, orbitals_array, 2)

pwd = os.getcwd()
graph_dir = os.path.join(pwd, '../graph')
save_dir = os.path.join(pwd)
raw_dir = ''
dateset_name = 'MoS2'
cuda = '5'
eporchs = '10000'
lr = '0.001'
a = gen_train_ini(orbital_set, atomic_number_set, graph_dir, save_dir, raw_dir, dateset_name, cuda, eporchs, lr)
